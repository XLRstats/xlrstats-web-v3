...
/* Custom caches for XLRstats */
Cache::config('1sec', array(
	'engine' => 'File',
	'duration' => '1',
	'prefix' => 'xlr_1sec_'
));

Cache::config('5secs', array(
	'engine' => 'File',
	'duration' => '5',
	'prefix' => 'xlr_5sec_'
));
...
Cache::config('1hour', array(
	'engine' => 'File',
	'duration' => '+1 hours',
	'prefix' => 'xlr_1hour_'
));

Cache::config('1week', array(
	'engine' => 'File',
	'duration' => '+1 week',
	'prefix' => 'xlr_1week_'
));
 ...
 * Only subdomains will actually show statistics.
 */
if ( isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] === 'www.xlrstats.com' ) {
	Configure::write('Route.default', array('controller' => 'pages', 'action' => 'display', 'xlrstats.com', 'home'));
} else {
...
Configure::write('App.defaultEmail', 'noreply@xlrstats.com');
