...
<div class="row">
	...
	<?php
		...
		foreach ($team as $k => $v) {
			...
			<tr><td colspan="5" style="text-align: right" class="muted"><small><? echo  $this->Number->toPercentage($registeredCount / $position * 100, 0) . ' ' . __('of this team is competing in XLRstats.') ?></small></td></tr>
			</table></div>
