...
<div class="row-fluid">
	<div class="span7">
			<?php if ($success): ?>
		<p class="alert alert-success"><i class="icon-large icon-ok-sign"></i> <?php echo __("Congratulations! Your server meets the basic software requirements."); ?></p>
		...
		<?php else: ?>
			<p class="alert alert-error"><i class="icon-large icon-warning-sign"></i> <?php echo __("Oops. There's a server compatibility issue. See below."); ?></p>
			<p>
			<ul>
